...
describe('Logger', () => {
    ...
    it('should log debug messages to stderr', () => {
        ...
        expect(consoleErrorSpy).toHaveBeenCalledWith(expect.stringContaining('[DEBUG] test message'));
    });
    ...
    it('should log warn messages to stderr', () => {
        ...
        expect(consoleErrorSpy).toHaveBeenCalledWith(expect.stringContaining('[WARN] test message'));
    });
    ...
    it('should format arguments correctly', () => {
        ...
        expect(consoleErrorSpy).toHaveBeenCalledWith(expect.stringContaining('{"foo":"bar"} 123'));
    });
});
